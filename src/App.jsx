  ...
  return (
    <>
     <div className="letter-container">
        <h1>Dear Soni Jain,</h1>
        <p>
            From the moment I met you, I knew you were special. Your smile lights up my day, and your presence makes everything better. I can't imagine my life without you. Will you be mine?
        </p>
        <div className="button-container">
            <button className="yes-button" ref={yesref} onClick={handleyes}>{yes}</button>
            <button className="no-button" ref={noref} onClick={handleno}>{no}</button>
        </div>
        {imagesrc && <>
          <div id="image-container" ref={imgref} >
            <img src={imagesrc} alt="Happy Image"/>
        </div>
        </>}
